...
def train_model(n_epochs=50, games_per_epoch=100, n_simulations=50, base_save_path='models'):
    """
    ...
    print(f"Starting training for {n_epochs} epochs with {games_per_epoch} games per epoch")
